document.addEventListener('DOMContentLoaded', async() => {    
    ...
    saveButton.addEventListener('click', function () {
        const confirm_pass = document.getElementById('password').value;

        // Call API to change password
        fetch('/api/user/delete-profile', {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${localStorage.getItem('received_Token')}` // Assuming the token is stored in localStorage
            },
            body: JSON.stringify({
        ...
        .then(data => {
            if (data) {
                ...
                window.location.href = '/'; // Redirect to profile page or another appropriate page
            } else {
    ...
    cancelButton.addEventListener('click', function () {
        window.location.href = '/account'; // Redirect to profile page or another appropriate page
    });
